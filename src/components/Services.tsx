  ...
  return (
    <section id="services" style={{ background: "#0A0A0A", padding: "100px 48px" }}>
      <div className="reveal" style={{ maxWidth: 1200, margin: "0 auto 60px", textAlign: "center" }}>
        <div className="section-label" style={{ justifyContent: "center" }}>Our System</div>
        <h2 className="section-headline" style={{ textAlign: "center" }}>ONE SYSTEM.<br />TWO POWERFUL TOOLS.</h2>
        <p className="section-sub" style={{ margin: "0 auto", textAlign: "center" }}>We handle everything — setup, scripting, targeting, execution, optimization. Your only job is showing up for the appointments we send you.</p>
      </div>
      ...
      <div className="reveal" style={{
        ...
        <div style={{ background: "#111111", padding: "56px 48px", position: "relative", overflow: "hidden" }}>
          ...
          <h3 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 44, lineHeight: 1, color: "#F5F2ED", marginBottom: 20, letterSpacing: 0.5 }}>WE DROP YOUR VOICE STRAIGHT INTO THEIR INBOX.</h3>
          <p style={{ fontSize: 15, lineHeight: 1.7, color: "#888880", marginBottom: 32, fontWeight: 300 }}>Your message lands directly in their voicemail — without their phone ever ringing. No interruption. No friction. They listen when they&apos;re ready, already hearing your voice, your offer, your business.</p>
          ...
          <div style={{ fontSize: 13, fontWeight: 600, letterSpacing: 0.5, color: "#FF5C00", paddingTop: 24, borderTop: "1px solid #222222" }}>THE RESULT: Warm prospects calling YOU back — already familiar with your name and offer.</div>
        </div>
        ...
        <div style={{ background: "#111111", padding: "56px 48px", position: "relative", overflow: "hidden" }}>
          ...
          <h3 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 44, lineHeight: 1, color: "#F5F2ED", marginBottom: 20, letterSpacing: 0.5 }}>YOUR AI AGENT WORKS LEADS 24/7 SO YOU DON&apos;T HAVE TO.</h3>
          <p style={{ fontSize: 15, lineHeight: 1.7, color: "#888880", marginBottom: 32, fontWeight: 300 }}>WhatsApp has a 98% message open rate. Our AI agent engages leads the moment they respond, asks the right qualifying questions, filters out the tire-kickers, and delivers only serious, appointment-ready prospects to you.</p>
          <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 12, marginBottom: 36, padding: 0 }}>
            {whatsapp.map((item) => (
              <li key={item} style={{ display: "flex", alignItems: "flex-start", gap: 12, fontSize: 14, color: "#F5F2ED", fontWeight: 300 }}>
          ...
          <div style={{ fontSize: 13, fontWeight: 600, letterSpacing: 0.5, color: "#25D366", paddingTop: 24, borderTop: "1px solid #222222" }}>THE RESULT: A qualification machine that hands you pre-vetted, motivated prospects ready to buy.</div>
        </div>
      </div>
    </section>
  );
