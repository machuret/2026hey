    ...
    <div style={{ background: BLK, color: WHITE, fontFamily: "'DM Sans',sans-serif" }}>
      ...
      <section style={{
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", position: "relative" }}>
          {/* Float badges */}
          <div style={{ position: "absolute", top: -24, left: -64, background: DARK2, border: `1px solid rgba(255,92,0,0.3)`, borderRadius: 6, padding: "12px 16px", whiteSpace: "nowrap", animation: "float 4s ease-in-out infinite" }}>
            <span style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 28, color: O, display: "block", lineHeight: 1 }}>3,000</span>
            <span style={{ fontSize: 11, color: MUTED, display: "block", marginTop: 2 }}>Drops per month</span>
          </div>
          <div style={{ position: "absolute", bottom: -24, right: -64, background: DARK2, border: `1px solid rgba(255,92,0,0.3)`, borderRadius: 6, padding: "12px 16px", whiteSpace: "nowrap", animation: "float 4s ease-in-out 2s infinite" }}>
            <span style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 28, color: O, display: "block", lineHeight: 1 }}>13%</span>
            <span style={{ fontSize: 11, color: MUTED, display: "block", marginTop: 2 }}>Avg callback rate</span>
          </div>
